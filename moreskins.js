CoolClock.config.skins = {
	...
	ipod_1:	{
		outerBorder:      { lineWidth: 0, radius: 120, color: "red", alpha: 1, color: "#F5F5F5"},
		smallIndicator:   { lineWidth: 1, startAt: 90, endAt: 92, color: "light-gray", alpha: 0.8 },
		largeIndicator:   { lineWidth: 2, startAt: 85, endAt: 92, color: "black", alpha: 1 },
		hourHand:         { lineWidth: 8,  startAt: -15, endAt: 50, color: "dark-grey", alpha: 1 },		
		minuteHand:       { lineWidth: 7, startAt: -15, endAt: 75, color: "dark-grey", alpha: 1 },
		secondHand:       { lineWidth: 2, startAt: -20, endAt: 70, color: "red", alpha: 1 },
